...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LogSenderTlsSettings) DeepCopyInto(out *LogSenderTlsSettings) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LogSenderTlsSettings.
func (in *LogSenderTlsSettings) DeepCopy() *LogSenderTlsSettings {
	if in == nil {
		return nil
	}
	out := new(LogSenderTlsSettings)
